(function () {
  ...
  function o(e) {
    ...
    if (
      (S && console.log('Got file of length ' + e.byteLength),
    ...
    for (var n, r = 2, i = e.byteLength; r < i; ) {
      ...
      if (((n = t.getUint8(r + 1)), S && console.log(n), 225 == n))
        return (
          S && console.log('Found 0xFFE1 marker'),
  ...
  function u(e, t, n, r, i) {
    ...
    switch (d) {
      ...
      case 10:
        ...
        for (a = [], l = 0; l < g; l++)
          a[l] = e.getInt32(m + 8 * l, !i) / e.getInt32(m + 4 + 8 * l, !i);
        return a;
    }
  }
  function c(e, t, n) {
  ...
  function g(e, t) {
    if ('Exif' != f(e, t, 4))
      return S && console.log('Not valid EXIF data! ' + f(e, t, 4)), !1;
    var n,
      r,
      i,
      o,
    ...
    if (18761 == e.getUint16(s)) n = !1;
      ...
      if (19789 != e.getUint16(s))
        return (
          S && console.log('Not valid TIFF data! (no 0x4949 or 0x4D4D)'), !1
        );
      n = !0;
    }
    if (42 != e.getUint16(s + 2, !n))
      return S && console.log('Not valid TIFF data! (no 0x002A)'), !1;
      ...
      for (var n = 2, r = e.byteLength, i = new DOMParser(); n < r - 4; ) {
        if ('http' == f(t, n, 4)) {
          var o = f(t, n - 1, t.getUint16(n - 2) - 1),
            ...
            s =
              (o = o.substring(o.indexOf('<x:xmpmeta'), a)).indexOf(
                'x:xmpmeta'
              ) + 10;
          return (
            (o =
